...
\Qitem{ \Qq{Ratio of Comments vs. Code is adequate?} \Qtab{3cm}{horrible \Qrating{5} fantastic}}
...
\Qitem{\Qq{Analysis only includes relevant codes?} (no code output which is not used afterwards) \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
