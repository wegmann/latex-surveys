...
\noindent \textit{Please note: not all item might be applicable - please cross-out any non-relevant part.}
...
\Qitem{\Qq{A header with information exists at the beginning of the script?} \Qtab{5.5cm}{\QO{} Yes
\hskip0.5cm \QO{} No}}
...
\Qitem{\Qq{Does the script uses a standard documentation structure/naming convention?} \hskip0.4cm \\
\QO{} absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }


\Qitem{\Qq{Script can be run easily on other data sets (generic code)?} \hskip0.4cm \\
\QO{} absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem{\Qq{Appropriate use of commands - no unnecessary complex code snippets?} \hskip0.4cm \\
\QO{} absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem{\Qq{(If a function) is provided: are example code/data provided/explained?} \hskip0.4cm \\
\QO{} absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem{ \Qq{Does the code minimize the storage of data?} (e.g. removal of unused variables) \Qtab{3cm}{\QO{} yes \hskip0.5cm \QO{} no}}
...
\Qitem{ \Qq{Script is actually a package?} \Qtab{3cm}{\QO{} yes \hskip0.5cm \QO{} no}}

\Qitem{ \Qq{Proper documentation (man pages) is provided for this package?} \Qtab{3cm}{\QO{} yes \hskip0.5cm \QO{} no}}

\subsubsection*{Code Impression}

\Qitem{ \Qq{The script triggered interest and you learned new things?} \Qtab{3cm}{yes, a lot \Qrating{5} no, not a bit}}


\Qitem{ \Qq{Please describe what was special/interesting:} \Qlines{3} }

\Qitem{ \Qq{Script is fast (based on performance measures)} \Qtab{3cm}{yes \Qrating{5} no}}
...
\Qitem{ \Qq{Which parts should be improved?} \Qlines{3} }


\Qitem{ \Qq{What is missing?} \Qlines{3} }
...
\Qitem{ \Qq{Plots/maps layout is consistent through-out the script?}  \hskip0.4cm \\
\QO{} absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
