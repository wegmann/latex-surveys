...
\Qitem{\Qq{Some information is provided at top of the script?} \Qtab{5.5cm}{\QO{} Yes
\hskip0.5cm \QO{} No}}
...
\Qitem{ \Qq{What do you think until now what the output/results will be? Describe it briefly before checking the actual script:} \Qlines{3} }
...
\Qitem{ \Qq{Ratio of Comments vs. Code?} \Qtab{3cm}{horrible \Qrating{5} fantastic}}

\Qitem{ \Qq{Easy to read (appropriate indentation and spacing)?} \Qtab{3cm}{horrible \Qrating{5} fantastic}}

\Qitem{ \Qq{The script is written for generic data analysis?} \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
...
\Qitem{ \Qq{Is the code flexible? (i.e allows inputs of different data types)?} \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem{ \Qq{Data can be retrieved without contacting the author?}  \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
...
\Qitem{\Qq{Are the variables derived within the code self-explanatory? (e.g. through clear variable names and/or comments)?} \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem{\Qq{Does the script uses a standard documentation structure/naming convention?} \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
...
\Qitem{\Qq{Appropriate use of commands - no unnecessary complex code snippets?} \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem{\Qq{(If a function) is provided: are example code/data provided/explained?} \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }

\Qitem[a]{ \Qq{Does the code minimize the storage of data (e.g. removal of unused variables)?)} \Qtab{3cm}{\QO{} yes \hskip0.5cm \QO{} no}}

\Qitem[a]{ \Qq{Does the code minimize the use of RAM? (e.g. appropriate subsetting, no re-reading data)?)} \Qtab{3cm}{\QO{} yes \hskip0.5cm \QO{} no}}

\Qitem[a]{ \Qq{Data handling and transformation is coherent and well commented?} \Qtab{3cm}{yes \Qrating{5} no}}

\Qitem{ \Qq{Novel code not covered in the course is used?} \Qtab{3cm}{a lot \Qrating{5} just known commands}}

\Qitem[a]{ \Qq{The script triggered interest and you learned new things?} \Qtab{3cm}{yes, a lot \Qrating{5} no, not a bit}}


\Qitem[b]{ \Qq{Please describe what was special/interesting:} \Qlines{2} }

\Qitem[a]{ \Qq{Script is fast (based on performance measures)} \Qtab{3cm}{yes \Qrating{5} no}}
...
\Qitem[b]{ \Qq{Which parts should be improved?} \Qlines{3} }


\Qitem[b]{ \Qq{What is missing?} \Qlines{3} }
...
\Qitem{ \Qq{Plots/maps layout is consistent?}  \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
...
\Qitem{ \Qq{Maps include landmarks, cities, roads for orientation?}  \hskip0.4cm \QO{}
absolutely \hskip0.5cm \QO{} not really because: \Qline{3cm} }
...
\Qitem{ \Qq{Aim} \Qtab{3cm}{horrible \Qrating{5}
fantastic}}
...
\Qitem{ \Qq{Please describe your impression.} \Qlines{3} }

\Qitem{ \Qq{When you check your anticipated results/output (Q 14) at the beginning - where you expectations met? and if no, why not:} \Qlines{3} }


\Qitem{ \Qq{What do you especially like about this script:} \Qlines{5} }

\Qitem{ \Qq{What do you especially \underline{dislike} about this script:} \Qlines{5} }
