...
\Qitem[a]{ \Qq{Script is fast (based on peformance measures)} \Qtab{3cm}{yes \Qrating{5} no}}

\Qitem[b]{ \Qq{Which parts should be improved?} \Qlines{2} }


\Qitem[a]{ \Qq{Data handling and transformation is coherent and well commented?} \Qtab{3cm}{yes \Qrating{5} no}}

\Qitem[b]{ \Qq{What is missing?} \Qlines{2} }
...
\Qitem{ \Qq{When you check your anticipated results/output (Q 13) at the beginning - where you expectations met? and if no, why not:} \Qlines{3} }
