...
\Qitem{ \Qq{Data handling and transformation is coherent and well commented?} \\ \Qtab{3cm}{yes \Qrating{5} no \hskip0.5cm \QO{} partly}}
...
\Qitem{ \Qq{Structure} \Qtab{3cm}{could be improved \Qrating{5}
fantastic}}

\Qitem{ \Qq{Innovation} \Qtab{3cm}{could be improved \Qrating{5}
fantastic}}
